/* -------------------------------------   Pin Definitions ------------------------------------------ 
  ...
  JBA - swapped 6&7 and 8&9 to avoid crossing wires

*/

/* azimuth pins --------------------- (use just the azimuth pins for an azimuth-only rotator) */

#define rotate_cw 7 // 8 // 6              // goes high to activate rotator R (CW) rotation - pin 1 on Yaesu connector
#define rotate_ccw 6 // 9 // 7             // goes high to activate rotator L (CCW) rotation - pin 2 on Yaesu connector
...
#define blink_led 0
#define az_stepper_motor_pulse 0  // 44
...
#define rotate_up 9 // 6 // 8               // goes high to activate rotator elevation up
#define rotate_down 8 // 7 // 9             // goes high to activate rotator elevation down
